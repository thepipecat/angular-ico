...
var ICON_CONFIGURATION = new core.InjectionToken('ICON_CONFIGURATION');
...
var AngularIconComponent = (function () {
    ...
    AngularIconComponent.ctorParameters = function () { return [
        ...
        { type: undefined, decorators: [{ type: core.Inject, args: [ICON_CONFIGURATION,] },] },
    ]; };
...
exports.ICON_CONFIGURATION = ICON_CONFIGURATION;
