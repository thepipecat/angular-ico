...
var AngularIconComponent = /** @class */ (function () {
    ...
    AngularIconComponent_1 = AngularIconComponent;
    ...
    AngularIconComponent.prototype.Setup = function () {
        var _this = this;
        if (this.name != null) {
            this.http.get(AngularIconComponent_1.baseUrl + "/" + this.name + ".svg", { responseType: 'text' })
    ...
    AngularIconComponent = AngularIconComponent_1 = __decorate([
        core_1.Component({
            selector: 'ui-icon',
            template: '<!-- icon space -->',
...
var AngularIconModule = /** @class */ (function () {
    ...
    AngularIconModule.forRoot = function (config) {
        ...
        angular_icon_component_1.AngularIconComponent.baseUrl = config.baseUrl;
        return {
